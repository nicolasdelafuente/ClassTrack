...
export function Button({
  ...
  return (
    <button
      type={type}
      className={cn(
        'inline-flex touch-manipulation items-center justify-center rounded-md border px-3 py-2 text-[13px] font-medium shadow-panel transition-[background-color,border-color,color,transform,filter,box-shadow] duration-200 ease-out motion-safe:active:scale-[0.98] disabled:cursor-not-allowed',
        variants[variant],
        className,
      )}
      {...props}
